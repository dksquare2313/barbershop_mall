      ...
      try {
        ...
        if (snapshot.empty) {
          ...
          const timesheet = {
            ...
            mon_end: parseTime(user.timesheet[0].end),

            tue_start: parseTime(user.timesheet[1].start),
            tue_end: parseTime(user.timesheet[1].end),

            wed_start: parseTime(user.timesheet[2].start),
            wed_end: parseTime(user.timesheet[2].end),
